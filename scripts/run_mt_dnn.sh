...
BERT_PATH="$TOP_DIR/mt_dnn_models/bert_model_large.pt"
DATA_DIR="$TOP_DIR/data/mt_dnn"
...
model_dir="$TOP_DIR/checkpoints/${prefix}_${optim}_answer_opt${answer_opt}_gc${grad_clipping}_ggc${global_grad_clipping}_${tstr}"
